...
class QuranPracticeScreen extends StatefulWidget {
  ...
  @override
  State<QuranPracticeScreen> createState() =>
      _QuranPracticeScreenState();
}

class _QuranPracticeScreenState
    extends State<QuranPracticeScreen> {
  ...
  void _checkRecitation() {
    ...
    final limit = actual.length < expected.length
        ? actual.length
        : expected.length;
    ...
    setState(() {
      ...
      _status = actual.isEmpty
          ...
          : 'Prototype comparison complete. '
              'This checks recognized words only; '
              'it is not a Tajweed verdict.';
    });
  }
  ...
  Future<void> _toggleListening() async {
    ...
    setState(() {
      ...
      _score = null;
      _status =
          'Listening... Recite the ayah clearly.';
      _listening = true;
    });
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Ayah ${verse['number']} of ${verses.length}',
                style: TextStyle(
                  color: isDark
                      ? Colors.white70
                      : Colors.black54,
